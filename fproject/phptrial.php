        ...
        <div class="d-flex justify-content-center align-items-center text-light">
            <div>
                ...
                <?php
                   ...
                   $url = $loc='https://api.whatsapp.com/send?text=!!E-TAG EMERGENCY ALERT!! E-Tag user is asking for emergency help. Location: https://maps.app.goo.gl/VcJD5KKahVVUYgV5A';
